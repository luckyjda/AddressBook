...
<html>
  <head>
    ...
    <style type="text/css">
    	 .first {
                list-style: none;
                background: url("images/left/cloud_current.png") no-repeat;
                padding-left: 20px;
                padding-right: 3px
            }
          .right {
  ...
  <body>
	  ...
	  <nav class="navbar navbar-inverse navbar-fixed-top">
	        <div class="container">
	          ...
	          <div id="navbar" class="navbar-collapse collapse">
	              <ul class="nav navbar-nav navbar-right">                        
	                  <li><a href="###" onclick="showAtRight('userList.jsp')"><i class="fa fa-users"></i> 学生列表</a></li>    
	                  <li><a href="###" onclick="showAtRight('teacherList.jsp')"><i class="fa fa-list-alt"></i> 教师列表</a></li>
	                  <li><a href="###" onclick="showAtRight('adminList.jsp')"><i class="fa fa-list"></i> 管理员列表</a></li>
	              </ul>
               ...
               <div class="col-sm-3 col-md-2 sidebar">        
                   <ul class="nav nav-sidebar">
                       ...
                       <ul id="userMeun" class="nav nav-list collapse menu-second">
                           ...
                           <li><a href="###" onclick="showAtRight('addStudent.jsp')"><i class="fa fa-cloud"></i> 添加学生</a></li>
                           <li><a href="###" onclick="showAtRight('modifyStudent.jsp')"><i class="fa fa-flask"></i> 修改学生</a></li>
                       ...
                       <li><a href="#recordMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
                           <i class="fa fa-file-text"></i>&nbsp; 管理员管理 <span class="sr-only">(current)</span></a>
                       </li> 
       ...
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header"><i class="fa fa-cog fa-spin"></i>&nbsp;控制台<small>&nbsp;&nbsp;&nbsp;欢迎使用学生后台管理系统</small></h1>
